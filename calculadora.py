...
boton1_parentesis2 = Button(ventana, text=")", width=5, height=2, command= lambda: click_boton(")"))
...
boton1_parentesis2.grid(row= 1, column= 2, padx= 5, pady=5)
...
boton1_rest.grid(row= 3, column= 3, padx= 5, pady=5)

boton1.grid(row= 4, column= 0, padx= 5, pady=5)
boton2.grid(row= 4, column= 1, padx= 5, pady=5)
boton3.grid(row= 4, column= 2, padx= 5, pady=5)
boton1_sum.grid(row= 4, column= 3, padx= 5, pady=5)
